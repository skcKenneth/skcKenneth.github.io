...
It starts with a map, not a drone.
...
![Simulation map: APF heatmap with hubs, route, and customers](../figures/simulation_map.png)
...
![Convergence curves for CMA-ES and ACO](../figures/convergence_curves.png)
...
![Runtime distributions for CMA-ES and ACO](../figures/runtime_boxplots.png)
...
![Robustness: distance, energy, feasibility](../figures/robustness_distributions.png)
...
![Sensitivity: route cost and energy under perturbations](../figures/sensitivity.png)
...
![Ablation: MMAS vs MMAS+2-opt and topology variants](../figures/ablation_variants.png)
