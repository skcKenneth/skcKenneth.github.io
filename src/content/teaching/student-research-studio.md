...
Student-suitable entries can be explored through the [project index](/projects/?availability=student). Public research notes such as [When the Timetable Lies to the Ventilation System](/writing/when-the-timetable-lies/) offer a bounded question, explicit counterevidence, and figures that can be critiqued without exposing the private computational workspace.
