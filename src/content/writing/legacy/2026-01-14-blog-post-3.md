...
summary: "The jetbike screams through the void, its engine a thunderclap in the silence of space. At the controls, Jaghatai Khan—the Warhawk, Primarch of the White Scars—pushes his mount to the absolute limit. Ahead, wreathed in toxic mist,..."
date: "2026-01-14"
lastUpdated: "2026-07-13"
featured: false
topics: ["Agent-Based Modeling","Physics Simulation","Stochastic Control","Python","Differential Equations","Warhammer 40K","Numerical Methods","Optimal Control"]
type: "Technical Tutorials"
archived: true
redirectFrom: ["/posts/2026/01/warhammer-stochastic-duel/"]
legacySource: "_posts/2026-01-14-blog-post-3.md"
scienceProject: "warhawk-stochastic"
technicalRepository: "https://github.com/skcKenneth/ScienceProject/tree/main/WARHAWK_STOCHASTIC"
---
...
The negative sign ensures drag always opposes motion. The absolute value $\mid v \mid$ ensures drag magnitude increases with speed regardless of direction. This is the standard **quadratic drag model** used in aerospace engineering.
...
- $m = 800$ kg (mass)
- Critical bonuses: 2.5× for $\mid v \mid > 30$ m/s, 1.7× for $|v| > 25$ m/s, 1.2× for $\mid v \mid  > 20$ m/s
...
For stability, we need $\Delta t < \frac{2}{\mid \lambda_{max} \mid}$ where $\lambda_{max}$ is the largest eigenvalue of the Jacobian. For our system, this requires $\Delta t < 0.01$ seconds, meaning 24,000 timesteps for a 240-second duel. This is computationally expensive.
